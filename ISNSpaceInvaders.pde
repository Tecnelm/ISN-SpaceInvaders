...
void ecranCredits(){
  ...
  text("Ecran d’accueil : Vincent",width>>1,height/5+30);
  text("Gestion des menus : Vincent / Clément G.",width>>1,height/5+60);
  text("Sons : Clément V.",width>>1,height/5+90);
  text("Gestion Clavier : Vincent",width>>1,height/5+120);
  text("Organisation du code / Commentaires : Clément V.",width>>1,height/5+150);
  text("Design et gestion des ennemis : Clément V. ",width>>1,height/5+180);
  text("Game design : Clément G., V. / Vincent",width>>1,height/5+210);
  text("Musique : \"Main Theme 8-BIT - ARMS\" - Loeder (Youtube)",width>>1,height/5+240);
  textFont(texte,20);
  text("Avec l'autorisation du créateur",width>>1,height/5+270);
  textFont(texte,30);
  text("Merci d'avoir joué!",width>>1,height/5+320);
  textFont(texte,30);
